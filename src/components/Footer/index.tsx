  ...
  return (
    <>
      <footer className="footer">
        ...
        <a href="https://www.facebook.com/DBServerTI/" target={"_blank"}>
          <FaFacebookSquare size={40} color='#4267B2'/>
        </a>
        <a href="https://www.instagram.com/dbserver_ti/" target={"_blank"}>
          <FaInstagramSquare size={40} color='#C13584'/>
        </a>
        <a href="https://twitter.com/dbserver_ti" target={"_blank"}>
          <FaTwitterSquare size={40} color='#1DA1F2'/>
        </a>
        <a href="https://br.linkedin.com/company/dbserver" target={"_blank"}>
